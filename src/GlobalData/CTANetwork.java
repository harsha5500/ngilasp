...
public class CTANetwork {
     ...
     */
    public final static int CTA_DONE_WITH_WORK = 0;
    /**
     * Value representing ready for next tick status for CTA
     */
    public final static int CTA_READY_FOR_NEXT_TICK = 1;
    /**
     ...
     */
    public final static int CTA_TIMED_OUT = 4;
    /**
     * The status of computing
     */
    public final static int CTA_COMPUTING = 6;
    /**
     * The status of Saving State
     */
    public final static int CTA_SAVING_STATE = 10;
    /**
     * The status of Saved State
     */
    public final static int CTA_SAVED_STATE = 8;
    /**
     * The status of Saved State
     */
    public final static int CTA_RESTORED_STATE = 9;
    /**
